...
public class UsuarioRegistro extends JPanel {
	...
	UsuarioRegistro(String rutaImagen) {
		...
		bIniciaSesion.setToolTipText("PULSA AQUI EN EL CASO DE QUE YA TENGAS UNA CUENTA EN RECETARIO");
		bRegistrarse.setToolTipText("PULSA AQUI PARA CREAR UNA CUENTA EN RECETARIO");
